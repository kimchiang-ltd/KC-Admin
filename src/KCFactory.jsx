...
// v1.4.244 (2026-06-30) — #233 Sortable column headers on BN list pages (InvoicePage + BNTIPage). Click any column header to sort asc/desc. Active column highlighted in accent color with ▲/▼ arrow. InvoicePage defaults to DN month descending; BNTIPage defaults to BN number descending.
